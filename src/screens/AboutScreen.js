...
export const AboutScreen = ({}) => {
  return (
    <View style={styles.center}>
      ...
      <Text style={styles.text}>Наверху группа кнопок переключает тип сортровки по языкам.</Text>
      <Text style={styles.text}>Поле фильтрации позволяет сделать быстрый поиск по выбранному языку.</Text>
